...
namespace
{
    ...
    {
        // TODO: Read the console-selected reference via RE::Console / F4SEVR
        return 0;
    }
}  // namespace

/// Plugin version descriptor (required by F4SEVR).
...
/// Plugin entry point called by F4SEVR after all game masters have loaded.
